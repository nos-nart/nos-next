    ...
    <section className="my-24" id="services">
      <div className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto flex flex-col w-full text-center justify-center">
        ...
        <div className="grid grid-flow-row sm:grid-flow-col grid-rows-2 md:grid-rows-1 sm:grid-cols-2 gap-8 py-6 sm:py-24">
          <div className="text-left flex flex-col justify-start items-start row-start-2 sm:row-start-1">
            ...
            <p className="text-gray-500 my-3">Platform allows you to see a reliable forecase of future income, combining all your sources of income.</p>
            <ul className="mt-4 text-left leading-7 text-gray-500 ml-6">
